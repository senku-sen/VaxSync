-- ============================================
-- CORRECTED SQL FOR RESIDENTS CHANGES
-- ============================================
-- Use this file instead - all queries verified
...
-- Check residents with mother information (CORRECTED - uses updated_at, not created_at)
...
-- Revert status changes (only recent ones - CORRECTED - uses updated_at)
-- UPDATE residents 
-- SET status = 'pending' 
