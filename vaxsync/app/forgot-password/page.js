            ...
            {!isSubmitted ? (
              <>
                ...
                <div className="mt-6 text-center">
                  <Link href="/login" className="text-sm text-[#3E5F44] hover:text-[#2d4532] font-semibold">
                    ← Back to Sign In
                  </Link>
                </div>
              </>
              ...
              <div className="text-center">
                ...
                <div className="bg-[#E8FFD7] border border-[#93DA97] rounded-lg p-4 mb-6">
                  <p className="text-xs text-gray-700">
                    ...
                    <button
                      ...
                      className="text-[#3E5F44] font-semibold hover:underline"
                    >
                      try again
                    </button>
                  </p>
                ...
                <Link
                  href="/login"
                  className="inline-block px-6 py-3 bg-gradient-to-r from-[#3E5F44] to-[#5E936C] text-white font-semibold rounded-lg hover:from-[#2d4532] hover:to-[#4a7255] transition-all shadow-md"
                >
                  Return to Sign In
                </Link>
              </div>
