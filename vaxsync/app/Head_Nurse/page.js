      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="p-6">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-5 flex items-center gap-3">
            ...
            <p className="text-sm text-red-800">{dashboardData.lowStockItems} vaccine types are running low. Please reorder soon.</p>
          </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  {alertData.criticalAlerts.map((alert) => (
                    <div
                      key={alert.id}
                      className="bg-red-50 border border-red-200 rounded-lg p-4 hover:shadow-md transition-all cursor-pointer"
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-start justify-between mb-2">
                            <div>
                              <h4 className="text-sm font-semibold text-gray-800">{alert.vaccineName}</h4>
                          ...
                          <p className="text-sm font-medium text-red-700 mb-2">{alert.message}</p>
                          <div className="grid grid-cols-2 gap-4 text-xs text-gray-600">
                            <div><span className="font-medium">Current Stock:</span> {alert.currentStock} doses</div>
                            <div><span className="font-medium">Location:</span> {alert.location}</div>
                            <div><span className="font-medium">Expiry Date:</span> {alert.expiryDate}</div>
                            <div><span className="font-medium">Threshold:</span> {alert.threshold} doses</div>
                          </div>
                          <div className="mt-3 flex items-center justify-between">
                            <span className="text-xs text-gray-400">{alert.timestamp}</span>
                            <button className="text-xs font-medium text-[#3E5F44] hover:text-[#2d4532]">
                              View Details →
                            </button>
                          </div>
                        </div>
            ...
            {alertData.warningAlerts.length > 0 && (
              <div>
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-base font-semibold text-gray-800">Warning Alerts</h3>
                ...
                <div className="space-y-3">
                  {alertData.warningAlerts.map((alert) => (
                    <div
                      key={alert.id}
                      className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 hover:shadow-md transition-all cursor-pointer"
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm font-medium text-yellow-700 mb-2">{alert.message}</p>
                          <div className="grid grid-cols-2 gap-4 text-xs text-gray-600">
                            <div><span className="font-medium">Current Stock:</span> {alert.currentStock} doses</div>
                            <div><span className="font-medium">Location:</span> {alert.location}</div>
                            <div><span className="font-medium">Expiry Date:</span> {alert.expiryDate}</div>
