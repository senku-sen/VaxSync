...
export default function Sidebar() {
  ...
  // MHO (Municipal Health Officer) menu items - REP-02
  const menuItems = [
    { name: 'Dashboard', path: `/Pages/MHO/Dashboard`, icon: 'dashboard' },
    { name: 'Inventory', path: `/Pages/MHO/Inventory`, icon: 'inventory' },
    { name: 'Vaccination Schedule', path: `/Pages/MHO/VaccinationSchedule`, icon: 'calendar' },
    { name: 'NIP Tracking', path: `/Pages/MHO/NIPTracking`, icon: 'users' },
    { name: 'Vaccine Requests', path: `/Pages/MHO/VaccineRequests`, icon: 'document' },
    { name: 'Reports', path: `/Pages/MHO/Reports`, icon: 'chart' },
  ];
